...
void startTimerForTemperature(vtTempStruct *vtTempdata) {
	...
	xTimerHandle TempTimerHandle = xTimerCreate((const signed char *)"Temp Timer",tempWRITE_RATE_BASE/tempI2C_RATE,pdTRUE,(void *) vtTempdata,TempTimerCallback);
