...
// Define whether to use demo I2C communication
#define USE_BWR_I2C_DEMO 1
...
int main( void )
{
	...
	#if USE_BWR_I2C_DEMO == 1
	// Initialize I2C devices: One for reading (slave) and one for writing (master)
