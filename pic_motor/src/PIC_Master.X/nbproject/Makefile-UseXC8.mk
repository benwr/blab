...
SOURCEFILES_QUOTED_IF_SPACED=../src/interrupts.c ../src/main.c ../src/messages.c ../src/my_i2c.c ../src/my_uart.c ../src/timer0_thread.c ../src/timer1_thread.c ../src/uart_thread.c ../src/user_interrupts.c ../src/debug.c
...
# Source Files
SOURCEFILES=../src/interrupts.c ../src/main.c ../src/messages.c ../src/my_i2c.c ../src/my_uart.c ../src/timer0_thread.c ../src/timer1_thread.c ../src/uart_thread.c ../src/user_interrupts.c ../src/debug.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-UseXC8.mk dist/${CND_CONF}/${IMAGE_TYPE}/PIC_Master.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
